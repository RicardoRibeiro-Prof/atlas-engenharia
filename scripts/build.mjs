...
await fs.writeFile(path.join(dist,'manifest.webmanifest'),JSON.stringify({name:site.name,short_name:'Atlas',start_url:site.base,scope:site.base,display:'browser',theme_color:'#1f2328',background_color:'#f2f2ef',icons:[{src:`${site.base}assets/favicon.svg`,sizes:'any',type:'image/svg+xml'}]},null,2))
